import pytest
from cogs.utilities.text_formatting_utils import pad_string, format_row, get_max_widths, calculate_display_width
import re
...
def test_right_alignment_spacing_pattern():
    ...
    print(f"\nRight alignment spacing test:")
    print(f"Single digit: '{single_digit}'")
    print(f"Double digit: '{double_digit}'")
    print(f"Negative digit: '{negative_digit}'")
